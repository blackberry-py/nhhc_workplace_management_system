...
if os.environ["DJANGO_ENV"] != "production":
    ...
    assert DEBUG is False, "DEBUG mode must be OFF in production!"
...
# SECTION - CDN static settings
# SECTION - BunnyCDN Platform settings
...
CELERY_BROKER_TRANSPORT_OPTIONS = {"visibility_timeout": 43200}  # 12 hours in seconds
