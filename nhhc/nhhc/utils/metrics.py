...
class NHHCMetrics:
    ...
    def __init__(self):
        ...
        self.docuseal_download_recorder = Histogram(
            "docuseal_download_duration", "Metric of the Durtation of downloading singed  Compliance Documents from the DocSeal External Signing Service to /tmp storage."
        )
