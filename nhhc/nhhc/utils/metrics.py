...
class NHHCMetrics:
    ...
    def __init__(self):
        ...
        self.s3_upload_recorder = Histogram("s3_upload_duration", "Metric of the Durtation of S3 upload of Compliance Documents from the application's /tmp to AWS S3 block storage.")
        self.docuseal_download_recorder = Histogram("docuseal_download_duration", "Metric of the Durtation of downloading singed  Compliance Documents from the DocSeal External Signing Service to /tmp storage.")
    ...
    def increment_cache(self, model:str, type:str) -> None:
        ...
        Args:
            ...
            type: The type of cache interaction ('hit', 'miss', or 'evicition').
