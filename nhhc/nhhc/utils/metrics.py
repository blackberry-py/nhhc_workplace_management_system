...
S3_UPLOAD = Histogram(
    ...
    documentation="Metric of the Duration of S3 upload of Compliance Documents from the application's /tmp to AWS S3 block storage.",
    unit="seconds",
    namespace="nhhc_compliance",
)
DOCUSEAL_DOWNLOAD = Histogram(
    name="docuseal_download_duration_seconds",
    documentation="Metric of the Duration of downloading singed  Compliance Documents from the DocSeal External Signing Service to /tmp storage.",
    unit="seconds",
    namespace="nhhc_compliance",
)
