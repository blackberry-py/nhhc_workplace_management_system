    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("emergency_contact_first_name", models.CharField(blank=True, max_length=10485760, null=True)),
                ...
                ("last_modifed", django_extensions.db.fields.ModificationDateTimeField(auto_now=True, null=True)),
            ],
            options={
