    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("idoa_agency_policies_attestation", models.FileField(blank=True, null=True, upload_to="idoa_agency_policies")),
                ("dhs_i9", models.FileField(blank=True, null=True, upload_to="i9")),
                ("marketing_recruiting_limitations_attestation", models.FileField(blank=True, null=True, upload_to="marketing_recruiting_limitations")),
                ("do_not_drive_agreement_attestation", models.FileField(blank=True, null=True, upload_to="do_not_drive_agreement")),
                ("job_duties_attestation", models.FileField(blank=True, null=True, upload_to="job_duties")),
                ("hca_policy_attestation", models.FileField(blank=True, null=True, upload_to="hca_policy")),
                ("irs_w4_attestation", models.FileField(blank=True, null=True, upload_to="irs_w4")),
                ("state_w4_attestation", models.FileField(blank=True, null=True, upload_to="state_w4")),
                ("idph_background_check_authorization", models.FileField(blank=True, null=True, upload_to="idph_bg_check_auth")),
                ("qualifications_verification", models.FileField(blank=True, null=True, upload_to="resume")),
                ("cpr_verification", models.FileField(blank=True, null=True, upload_to="cpr_verification")),
                (
                    "family_hca",
                    models.CharField(
