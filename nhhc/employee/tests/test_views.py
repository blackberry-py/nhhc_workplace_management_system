...
from employee.views import hire, promote, reject, terminate
...
class TestEmployeeViews(TestCase):
    ...
    def test_hire_success(self):
        ...
        with patch("employee.views.EmploymentApplicationModel.objects.get") as mock_get:
            ...
            mock_applicant.hire_applicant.return_value = {"email": "test@example.com", "first_name": "John", "plain_text_password": "password", "username": "john_doe", "employee_id": 17}
