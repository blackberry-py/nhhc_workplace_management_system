...
RUN apt-get update && apt-get install -y --no-install-recommends apt-transport-https ca-certificates curl gnupg make && \
...
COPY --chown=nhhc_app:nhhc requirements_prod.txt ./requirements.txt
